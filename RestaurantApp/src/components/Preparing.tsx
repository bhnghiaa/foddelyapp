        ...
        return (
            <ScrollView refreshControl={
                ...
                <View style={styles.emptyState}>
                    <Text style={styles.emptyStateText}>Không có đơn hàng đang chuẩn bị</Text>
                </View>
            </ScrollView>
        );
    }
        ...
        return (
            <View style={styles.orderCard}>
                ...
                <TouchableOpacity style={styles.preparingButton} onPress={() => handleReady(order._id)}>
                    ...
                    <Text style={styles.preparingButtonText}>Sẵn sàng</Text>
                </TouchableOpacity>
            </View>
        )
    }
