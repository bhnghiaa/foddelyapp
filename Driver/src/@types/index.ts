...
type RootStackParamList = ParamListBase & {
    ...
    Location: { address: string, deliveryAddress: string};
    Cart: undefined;
...
export type { Coordinates, Category, Rating, ChoicesListType, RestaurantType, FoodItems, OrderItem, Order, User, Additive, RootStackParamList,Cart };