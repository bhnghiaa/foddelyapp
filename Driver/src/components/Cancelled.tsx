...
const Cancelled: FC<Props> = (props) => {
    const navigation = useNavigation<NavigationProp<RootStackParamList>>();
    const { orders, loading, error, refetch } = useFetchOrders('Cancelled');
        ...
        return (
            <ScrollView refreshControl={
                ...
                <View style={styles.emptyState}>
                    <Text style={styles.emptyStateText}>Không có đơn hàng đã hủy</Text>
                </View>
            </ScrollView>
        );
    }
